...
import (
	...
	"github.com/micromize-dev/sigward/internal/sbom"
)
...
// Event type constants matching include/sigward/event_types.h
const (
	eventTypeUnknown                  = 0
	eventTypeUnattestedBinary         = 1
	eventTypeHashMismatch             = 2
	eventTypeUnattestedSharedObject   = 3
	eventTypeSharedObjectHashMismatch = 4
)
